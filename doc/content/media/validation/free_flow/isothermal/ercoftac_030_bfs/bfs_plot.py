...
df_in = pd.read_csv(validation_folder + 'reference_csv/reference_bfs_input_csv_inlet_sampler_0002.csv')
df_out = pd.read_csv(validation_folder + 'reference_csv/reference_bfs_input_csv_outlet_sampler_0002.csv')
...
if plot_reference_results:
    ax1.plot(x/H, pressure/cp_factor + 0.125, 'g', label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
    ax1.plot(sim_x/H, sim_pressure/cp_factor + 0.125, 'b', label='MOOSE-FV: K-epsilon current')
...
if plot_reference_results:
    ax1.plot(x/H, (mu_t*vel_x/distance)/cf_factor, 'g', label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
...
if plot_reference_results:
    ax1.plot(interpolated_results['reference_csv/reference_bfs_input_csv_vel_x_xoH_1_sampler_0002.csv'], y_grid, 'g', label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
...
if plot_reference_results:
    ax2.plot(interpolated_results['reference_csv/reference_bfs_input_csv_vel_x_xoH_4_sampler_0002.csv'], y_grid, 'g', label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
...
if plot_reference_results:
    ax3.plot(interpolated_results['reference_csv/reference_bfs_input_csv_vel_x_xoH_6_sampler_0002.csv'], y_grid, 'g', label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
...
if plot_reference_results:
    ax4.plot(interpolated_results['reference_csv/reference_bfs_input_csv_vel_x_xoH_10_sampler_0002.csv'], y_grid, 'g', label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
...
if plot_reference_results:
    ax5.plot(ercoftac_x_cp, moose_cp_interp, color='g', linestyle='--', marker='o', markersize=4, label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
...
if plot_reference_results:
    ax6.plot(ercoftac_x_cf, moose_cf_interp, color='g', linestyle='--', marker='o', markersize=4, label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
...
if plot_reference_results:
    ax1.plot(u_moose_1, y_grid, linestyle='--', color='g', marker='o', markersize=4, label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
...
if plot_reference_results:
    ax2.plot(u_moose_4, y_grid, linestyle='--', color='g', marker='o', markersize=4, label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
...
if plot_reference_results:
    ax3.plot(u_moose_6, y_grid, linestyle='--', color='g', marker='o', markersize=4, label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
...
if plot_reference_results:
    ax4.plot(u_moose_10, y_grid, linestyle='--', color='g', marker='o', markersize=4, label='MOOSE-FV: K-epsilon reference')
if plot_current_results:
