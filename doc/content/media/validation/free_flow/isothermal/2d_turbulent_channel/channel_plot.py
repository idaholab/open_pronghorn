...
# Load .csv files
df_395_MOOSE_linear = pd.read_csv(
    "../../../../../../../validation/free_flow/isothermal/ercoftac_032_channel_flow/gold/Ret395_MOOSE_LSFV_k-epsilon_test_csv_0002.csv"
)
df_395_ercoftac = pd.read_csv(
    "../../../../../../../validation/free_flow/isothermal/ercoftac_032_channel_flow/gold/Ret395.csv"
)

# Problem Parameters
nu = 2.0 / 14000.0  # Bulk Reynolds number
yd = 0.125  # Centroid distance from wall
rho = 1  # Density

# Compute u_tau for MOOSE Linear SIMPLE FV with k-epsilon
yplus_MOOSE_linear = df_395_MOOSE_linear["yplus"].iloc[
    -1
]  # y+ value at the outlet (obtained from the MOOSE simulation results)
...
ax1.plot(
    df_395_MOOSE_linear["y"][::2],
    df_395_MOOSE_linear["vel_x"][::2] / u_tau_MOOSE_linear,
    "rx",
    markersize=6,
    label="MOOSE: FV k-eps",
)
...
# Plotting
ax2.semilogx(
    (1.0 - df_395_MOOSE_linear["y"][::2][10:]) * u_tau_MOOSE_linear / nu,
    df_395_MOOSE_linear["vel_x"][::2][10:] / u_tau_MOOSE_linear,
    "rx",
    markersize=6,
    label="MOOSE: FV k-eps",
)
...
# Load .csv files
df_590_ercoftac = pd.read_csv(
    "../../../../../../../validation/free_flow/isothermal/ercoftac_032_channel_flow/gold/Ret590.csv"
)
df_590_MOOSE_linear = pd.read_csv(
    "../../../../../../../validation/free_flow/isothermal/ercoftac_032_channel_flow/gold/Ret590_MOOSE_LSFV_k-epsilon_test_csv_0002.csv"
)

# Problem Parameters
nu = 2.0 / 22250.0  # Bulk Reynolds number
yd = 0.08  # Distance to wall-centroid
rho = 1  # Density

# Compute u_tau for MOOSE Linear SIMPLE FV with k-epsilon
yplus_MOOSE_linear = df_590_MOOSE_linear["yplus"].iloc[
    -1
]  # y+ obtained from the MOOSE simulation results
u_tau_MOOSE_linear = yplus_MOOSE_linear * nu / yd
...
# Plotting
ax1.plot(
    df_590_MOOSE_linear["y"][::2],
    df_590_MOOSE_linear["vel_x"][::2] / u_tau_MOOSE_linear,
    "rx",
    markersize=6,
    label="MOOSE: FV k-eps",
)
...
# Plotting
ax2.semilogx(
    (1.0 - df_590_MOOSE_linear["y"][1::2][10:]) * u_tau_MOOSE_linear / nu,
    df_590_MOOSE_linear["vel_x"][1::2][10:] / u_tau_MOOSE_linear,
    "rx",
    markersize=6,
    label="MOOSE: FV k-eps",
)
