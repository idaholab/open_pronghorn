...
moose_fluid_df = read_moose(
    "../../../../../../../validation/free_flow/heat_transfer/flat_plate/gold/cht_rob-rob_out_y_vs_tf_0001.csv",
    "y",
)
moose_solid_df = read_moose(
    "../../../../../../../validation/free_flow/heat_transfer/flat_plate/gold/cht_rob-rob_out_y_vs_ts_0001.csv",
    "y",
)
...
if print_commercial_cfd:
    ax.plot(
        reference_cfd_df["y"], reference_cfd_df["T"], "--", label="Commercial CFD tool"
    )
