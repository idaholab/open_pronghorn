...
OpenPronghorn based on a **drift-flux** formulation. It is intended to complement the
RANS turbulence modeling documentation and follows a similar level of detail and
structure. fileciteturn1file0
...
(e.g., Lai & Nazaroff [!cite](lai2000deposition,nazaroff1993indoor)). The drift-flux
implementation here follows Gray et al. [!cite](gray2025driftflux) for CFD modeling of
