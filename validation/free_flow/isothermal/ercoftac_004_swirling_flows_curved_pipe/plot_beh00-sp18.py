...
ERCOFTAC Anwer & So (case004) experimental data, at s/D = 18 downstream of the bend,
...
exp_path = Path('swb-allfiles/beh00-sp18.dat')
...
fig.suptitle(r's/D = 18, horizontal plane (plane AA)')
fig.tight_layout()
fig.savefig('comparison_beh00-sp18.png', dpi=300, bbox_inches='tight')
print('Saved comparison_beh00-sp18.png')
