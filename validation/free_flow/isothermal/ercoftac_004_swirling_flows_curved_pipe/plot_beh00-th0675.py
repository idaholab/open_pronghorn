...
ERCOFTAC Anwer & So (case004) experimental data, at theta = 67.5 degrees
...
exp_path = Path('swb-allfiles/beh00-th0675.dat')
...
v4_csv = 'curvedpipe_noswirl_v4_csv_beh00_th0675_0002.csv'
...
fig.suptitle(r'theta = 67.5 deg, horizontal plane (plane AA)')
fig.tight_layout()
fig.savefig('comparison_beh00-th0675.png', dpi=300, bbox_inches='tight')
print('Saved comparison_beh00-th0675.png')
