...
line, i.e. positive = outward = toward the outer wall. At theta=112.5/157.5,
where ERCOFTAC's own page documents "a second cell in the secondary flow",
U flips sign (negative on the outer half, positive on the inner half) --
that is the second cell reversing the flow locally near the outer wall, not
...
theta=22.5/67.5 and s/D=1, which contradicts both the literature and the
real data. This has been reverted.)
"""
