...
ERCOFTAC Anwer & So (case004) experimental data, at s/D = 6 downstream of
...
exp_path = Path('swb-allfiles/bev00-sp06.dat')
...
v4_csv = 'curvedpipe_noswirl_v4_csv_bev00_sp06_0002.csv'
...
fig.suptitle(r's/D = 6, vertical plane (plane BB)')
fig.tight_layout()
fig.savefig('comparison_bev00-sp06.png', dpi=300, bbox_inches='tight')
print('Saved comparison_bev00-sp06.png')
