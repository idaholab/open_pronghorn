...
ERCOFTAC Anwer & So (case004) experimental data, at s/D = 6 downstream of the bend,
...
exp_path = Path('swb-allfiles/beh00-sp06.dat')
...
v4_csv = 'curvedpipe_noswirl_v4_csv_beh00_sp06_0002.csv'
...
fig.suptitle(r's/D = 6, horizontal plane (plane AA)')
fig.tight_layout()
fig.savefig('comparison_beh00-sp06.png', dpi=300, bbox_inches='tight')
print('Saved comparison_beh00-sp06.png')
