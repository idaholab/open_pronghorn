...
exp_path = Path('swb-allfiles/bev00-th0675.dat')
...
v4_csv = 'curvedpipe_noswirl_v4_csv_bev00_th0675_0002.csv'
...
fig.suptitle(r'theta = 67.5 deg, vertical plane (plane BB)')
fig.tight_layout()
fig.savefig('comparison_bev00-th0675.png', dpi=300, bbox_inches='tight')
print('Saved comparison_bev00-th0675.png')
