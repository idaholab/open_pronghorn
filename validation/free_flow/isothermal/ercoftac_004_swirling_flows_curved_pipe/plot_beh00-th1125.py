...
ERCOFTAC Anwer & So (case004) experimental data, at theta = 112.5 degrees
...
in the secondary flow": the real beh00-th1125.dat file shows U NEGATIVE
...
exp_path = Path('swb-allfiles/beh00-th1125.dat')
...
v4_csv = 'curvedpipe_noswirl_v4_csv_beh00_th1125_0002.csv'
...
fig.suptitle(r'theta = 112.5 deg, horizontal plane (plane AA)')
fig.tight_layout()
fig.savefig('comparison_beh00-th1125.png', dpi=300, bbox_inches='tight')
print('Saved comparison_beh00-th1125.png')
