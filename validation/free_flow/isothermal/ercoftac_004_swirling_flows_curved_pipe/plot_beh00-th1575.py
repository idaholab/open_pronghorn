...
exp_path = Path('swb-allfiles/beh00-th1575.dat')
...
v4_csv = 'curvedpipe_noswirl_v4_csv_beh00_th1575_0002.csv'
...
fig.suptitle(r'theta = 157.5 deg, horizontal plane (plane AA)')
fig.tight_layout()
fig.savefig('comparison_beh00-th1575.png', dpi=300, bbox_inches='tight')
print('Saved comparison_beh00-th1575.png')
